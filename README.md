This project contains the .onnx file that was used for the Expo App created online, and also contains the model training python file, specified with model weights and dataset links. However, the dataset cannot be directly added to GitHub. 
